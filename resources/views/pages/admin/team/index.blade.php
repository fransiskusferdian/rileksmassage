                    ...
                    @foreach ($items as $item)
                        <div class="card mr-2" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">{{$item->position}}
                                </p>
                                <a href="" data-href="{{route('deleteteam', $item->id)}}" class="btn btn-danger" data-toggle="modal"
                                    data-target="#deleteTeamModal"><i class="fa fa-trash"></i>
                                </a>
                                <a href="{{route('editteam', $item->id)}}" class="btn btn-warning">
